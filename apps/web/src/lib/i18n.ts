...
const th = {
  ...
  common: {
    ...
    contactLab: "ติดต่อแลป",
    tempName: "(ชื่อชั่วคราว)",
  },
  home: {
    videoCaption: "วิดีโอแนะนำแลป (ตำแหน่งตัวอย่าง — เปลี่ยนลิงก์ได้จากระบบ admin)",
    whatWeDo: "What we do",
    whatWeDoTitle: "แลปของเราทำอะไร",
    ...
    partnersLead: "หน่วยงานที่ร่วมงานกับแลป",
    blogTitle: "กิจกรรมล่าสุดของแลป",
  ...
  about: {
    ...
    milestonesTitle: "เส้นทางของแลป",
    milestonesLead: "เหตุการณ์สำคัญของแลป",
    ctaTitle: "สนใจร่วมงานหรือเยี่ยมชมแลป?",
    ctaLead: "ติดต่อเราเพื่อนัดหมายชมเดโมระบบ หรือหารือความร่วมมือด้านงานวิจัย",
    imgPlaceholder: "รูปทีมแลป / ห้องปฏิบัติการจริงจะใส่ตรงนี้",
  },
  solutions: {
    title: "Solution & Product",
    lead: "เราออกแบบโซลูชันจากงานวิจัยของแลปเอง ให้เหมาะกับโจทย์ของแต่ละเมืองและหน่วยงาน เลือกดูตามหมวดด้านล่าง",
  ...
  contact: {
    ...
    topics: ["สอบถามข้อมูลโซลูชัน", "นัดชมเดโม / เยี่ยมชมแลป", "ความร่วมมือ / พาร์ทเนอร์", "อื่น ๆ"],
    fMsg: "ข้อความ *",
    fMsgPh: "รายละเอียดที่ต้องการสอบถาม",
    note: "ระบบจริงจะติดตั้งตัวกันสแปม (Turnstile/reCAPTCHA) — ข้อความถูกเก็บใน DB และส่งเข้าอีเมลแลป",
    send: "ส่งข้อความ",
    sending: "กำลังส่ง...",
    ...
    mapLead: "ปักหมุดตำแหน่งแลปที่ สจล. ลาดกระบัง — กดแล้วเปิดนำทางได้",
  },
  footer: {
...
const en: typeof th = {
  ...
  home: {
    videoCaption: "Lab introduction video (placeholder — link editable via admin)",
    whatWeDo: "What we do",
    whatWeDoTitle: "What our lab does",
    ...
    partnersLead: "Organizations working with the lab",
  ...
  about: {
    ...
    milestonesLead: "Key milestones of the lab",
    ctaTitle: "Interested in collaborating or visiting the lab?",
    ctaLead: "Contact us to schedule a demo or discuss research collaboration",
    imgPlaceholder: "Team / laboratory photo goes here",
  },
  solutions: {
    title: "Solution & Product",
  ...
  contact: {
    ...
    fPhone: "Phone",
    fTopic: "Topic",
    topics: ["Solution inquiry", "Book a demo / lab visit", "Partnership", "Other"],
    fMsg: "Message *",
    fMsgPh: "What would you like to ask?",
    note: "The live system will add spam protection (Turnstile/reCAPTCHA) — messages are stored and emailed to the lab",
    send: "Send message",
    sending: "Sending...",
